 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |L_Alt |LCtrl |Lower |Space |Enter |Raise |LSuper|R_Alt |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_LALT, KC_LCTL, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_LGUI, KC_RALT, _______, _______
),
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, QK_RBT,   DB_TOGG,   QWERTY,  COLEMAK, OS_MAC,  OS_LNX,  KC_SLEP, KC_WAKE, XXXXXXX, KC_PWR,  _______,
    _______, UG_TOGG, UG_NEXT, UG_HUEU, UG_SATU, UG_VALU, KC_MNXT, KC_MUTE, KC_VOLU, KC_BRIU, XXXXXXX, _______,
    _______, AU_TOGG,  XXXXXXX, UG_HUED, UG_SATD, UG_VALD, KC_MPRV, KC_MPLY, KC_VOLD, KC_BRID, XXXXXXX, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
